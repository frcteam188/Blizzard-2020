...
public class FarHoodPID extends CommandBase {
  ...
  @Override
  public void execute() {
    hoodPIDController.setReference(RobotMath.getTrenchHoodAngleFromDistance(shooter), ControlType.kPosition);
  }
